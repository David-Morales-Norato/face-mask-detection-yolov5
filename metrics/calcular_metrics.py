...
sys.path.insert(1, 'Object_Detection_Metrics_master')
###########################################################################################
#                                                                                         #
...
path_guardar_plot = "/mnt/c/Users/NARUTO/Documents/Materias/IA2/2nd dataset/metrics/images_results"
# Read txt files containing bounding boxes (ground truth and detections)
...
evaluator.PlotPrecisionRecallCurve(
    ...
    showInterpolatedPrecision=True,showGraphic=True, savePath=path_guardar_plot)  # Plot the interpolated precision curve
